...
if [ ! -d $PROJECT ]; then
	...
	cordova create ../../intervaluebuilds/project-$1 org.intervalue.wallet InterValue-1.0-testnet
	checkOK
...
#  checkOK
#
#  cp ios/InterValue-1.0-testnet-Info.plist $PROJECT/platforms/ios/InterValue-1.0-testnet-Info.plist
#  checkOK
#
#  mkdir -p $PROJECT/platforms/ios/InterValue-1.0-testnet/Resources/icons
#  checkOK
#
#  mkdir -p $PROJECT/platforms/ios/InterValue-1.0-testnet/Resources/splash
#  checkOK
#
#  cp -R ios/icons/* $PROJECT/platforms/ios/InterValue-1.0-testnet/Resources/icons
#  checkOK
#
#  cp -R ios/splash/* $PROJECT/platforms/ios/InterValue-1.0-testnet/Resources/splash
#  checkOK
fi
